...
(defcfun "fbsql_database_new" :pointer
  (host :string)
  (db :string)
  (user :string)
  (passwd :string)
...
(defcfun "fbsql_database_new_default"   :pointer (dbpath :string))
(defcfun "fbsql_database_connect"       :void    (db :pointer))
(defcfun "fbsql_database_connected"     :uint32   (db :pointer))
(defcfun "fbsql_database_inactivate"    :void    (db :pointer))
(defcfun "fbsql_database_disconnect"    :void    (db :pointer))
(defcfun "fbsql_database_create"        :void    (db :pointer) (dialect :uint32))
(defcfun "fbsql_database_drop"          :void    (db :pointer))
(defcfun "fbsql_database_statistics"    :void    (db :pointer) (fetches :pointer) (marks :pointer) (reads :pointer) (writes :pointer))
(defcfun "fbsql_database_counts"        :void    (db :pointer) (inserts :pointer) (updates :pointer) (deletes :pointer) (read-indexes :pointer) (read-sequential :pointer))
(defcfun "fbsql_database_users"         :pointer (db :pointer))
(defcfun "fbsql_database_dialect"       :uint32   (db :pointer))
(defcfun "fbsql_database_servername"    :pointer (db :pointer))
(defcfun "fbsql_database_database"      :pointer (db :pointer))
(defcfun "fbsql_database_user"          :pointer (db :pointer))
(defcfun "fbsql_database_password"      :pointer (db :pointer))
(defcfun "fbsql_database_role"          :pointer (db :pointer))
(defcfun "fbsql_database_charset"       :pointer (db :pointer))
(defcfun "fbsql_database_create_params" :pointer (db :pointer))
(defcfun "fbsql_database_delete"        :pointer (db :pointer))

;;;; fbsql_users functions
(defcfun "fbsql_users_count"  :unsigned-int (users :pointer))
(defcfun "fbsql_users_get"    :string       (users :pointer) (index :unsigned-int))
(defcfun "fbsql_users_delete" :void         (users :pointer))
...
(defcfun "fbsql_transaction_new"              :pointer (db :pointer) 
...
(defcfun "fbsql_transaction_new_with_defaults" :pointer (db :pointer))
(defcfun "fbsql_transaction_start"             :void (tr :pointer))
(defcfun "fbsql_transaction_started"           :uint32 (tr :pointer))
(defcfun "fbsql_transaction_rollback"          :void (tr :pointer))
(defcfun "fbsql_transaction_commit"            :void (tr :pointer))
(defcfun "fbsql_transaction_commit_retaining"  :void (tr :pointer))
(defcfun "fbsql_transaction_add_reservation"   :void 
 (tr :pointer) 
 (db :pointer) 
 (table :string) 
 (reservation fbsql-transaction-table-reservation))
(defcfun "fbsql_transaction_attach_database"   :void
 (tr :pointer)
 (db :pointer) 
 (access-mode fbsql-transaction-access-mode)
 (isolation-level fbsql-transaction-isolation-level)
 (lock-resolution fbsql-transaction-lock-resolution)
 (factory-flags fbsql-transaction-factory-flags))
(defcfun "fbsql_transaction_detach_database"   :void (tr :pointer) (db :pointer))
(defcfun "fbsql_transaction_delete"            :void (tr :pointer))
...
(defcfun "fbsql_statement_new"                           :pointer          (db :pointer) (tr :pointer))
(defcfun "fbsql_statement_prepare"                       :void             (st :pointer) (sql :string))
(defcfun "fbsql_statement_execute"                       :void             (st :pointer))
(defcfun "fbsql_statement_execute_immediate"             :void             (st :pointer) (sql :string))
(defcfun "fbsql_statement_affected_rows"                 :uint32            (st :pointer))
(defcfun "fbsql_statement_sql"                           :string           (st :pointer))
(defcfun "fbsql_statement_plan"                          :string           (st :pointer))
(defcfun "fbsql_statement_close"                         :void             (st :pointer))
(defcfun "fbsql_statement_fetch"                         :uint32            (st :pointer))
(defcfun "fbsql_statement_is_null"                       :uint32            (st :pointer) (column :uint32))
(defcfun "fbsql_statement_is_null_by_name"               :uint32            (st :pointer) (column :string))
(defcfun "fbsql_statement_column_num"                    :uint32            (st :pointer) (column :string))
(defcfun "fbsql_statement_column_name"                   :string           (st :pointer) (column :uint32))
(defcfun "fbsql_statement_column_alias"                  :string           (st :pointer) (column :uint32))
(defcfun "fbsql_statement_column_table"                  :string           (st :pointer) (column :uint32))
(defcfun "fbsql_statement_column_type"                   fbsql-data-type   (st :pointer) (column :uint32))
(defcfun "fbsql_statement_column_subtype"                :uint32            (st :pointer) (column :uint32))
(defcfun "fbsql_statement_column_size"                   :uint32            (st :pointer) (column :uint32))
(defcfun "fbsql_statement_column_count"                  :uint32            (st :pointer))
(defcfun "fbsql_statement_parameter_type"                fbsql-data-type   (st :pointer) (parameter :uint32))
(defcfun "fbsql_statement_parameter_subtype"             :uint32            (st :pointer) (parameter :uint32))
(defcfun "fbsql_statement_parameter_size"                :uint32            (st :pointer) (parameter :uint32))
(defcfun "fbsql_statement_parameter_scale"               :uint32            (st :pointer) (parameter :uint32))
(defcfun "fbsql_statement_parameter_count"               :uint32            (st :pointer))
(defcfun "fbsql_statement_get_bool"                      :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_short"                     :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_integer"                   :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_longint"                   :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_string_size"               :uint32            (st :pointer) (column :uint32))
(defcfun "fbsql_statement_get_string"                    :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_float"                     :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_double"                    :uint32            (st :pointer) (column :uint32) (value :pointer))
(defcfun "fbsql_statement_get_timestamp"                 :pointer          (st :pointer) (column :uint32))
...
(defcfun "fbsql_statement_set_null"                      :void             (st :pointer) (column :uint32))
(defcfun "fbsql_statement_set_bool"                      :void             (st :pointer) (column :uint32) (value :uint32))
(defcfun "fbsql_statement_set_short"                     :void             (st :pointer) (column :uint32) (value :uint16))
(defcfun "fbsql_statement_set_integer"                   :void             (st :pointer) (column :uint32) (value :uint32))
(defcfun "fbsql_statement_set_longint"                   :void             (st :pointer) (column :uint32) (value :uint64))
(defcfun "fbsql_statement_set_string"                    :void             (st :pointer) (column :uint32) (value :string))
(defcfun "fbsql_statement_set_float"                     :void             (st :pointer) (column :uint32) (value :float))
(defcfun "fbsql_statement_set_double"                    :void             (st :pointer) (column :uint32) (value :double))
(defcfun "fbsql_statement_set_timestamp"                 :void             (st :pointer) (column :uint32) (value :pointer))
...
(defcfun "fbsql_statement_delete"                        :void             (st :pointer))

;;;; fbsql_timestamp functions
(defcfun "fbsql_timestamp_new"          :pointer)
(defcfun "fbsql_timestamp_new_time"     :pointer (hour :uint32) (minute :uint32) (second :uint32) (tenthousands :uint32))
(defcfun "fbsql_timestamp_new_date"     :pointer (year :uint32) (month  :uint32) (day    :uint32))
(defcfun "fbsql_timestamp_new_datetime" :pointer (year :uint32) (month  :uint32) (day    :uint32) (hour :uint32) (minute :uint32) (second :uint32) (tenthousands :uint32))
(defcfun "fbsql_timestamp_set_time"     :void    (ts :pointer) (hour :uint32) (minute :uint32) (second :uint32) (tenthousands :uint32))
(defcfun "fbsql_timestamp_set_date"     :void    (ts :pointer) (year :uint32) (month  :uint32) (day    :uint32))
(defcfun "fbsql_timestamp_set_datetime" :void    (ts :pointer) (year :uint32) (month  :uint32) (day    :uint32) (hour :uint32) (minute :uint32) (second :uint32) (tenthousands :uint32))
(defcfun "fbsql_timestamp_get_time"     :void    (ts :pointer) (hour :pointer) (minute :pointer) (second :pointer) (tenthousands :pointer))
(defcfun "fbsql_timestamp_get_date"     :void    (ts :pointer) (year :pointer) (month  :pointer) (day    :pointer))
(defcfun "fbsql_timestamp_get_datetime" :void    (ts :pointer) (year :pointer) (month  :pointer) (day    :pointer) (hour :pointer) (minute :pointer) (second :pointer) (tenthousands :pointer))
(defcfun "fbsql_timestamp_clear"        :void    (ts :pointer))
(defcfun "fbsql_timestamp_today"        :void    (ts :pointer))
(defcfun "fbsql_timestamp_before"       :uint32     (lhs :pointer) (rhs :pointer))
(defcfun "fbsql_timestamp_equal"        :uint32     (lhs :pointer) (rhs :pointer))
(defcfun "fbsql_timestamp_now"          :void    (ts :pointer))
(defcfun "fbsql_timestamp_delete"       :void    (ts :pointer))

;;;; fbsql_blob functions
(defcfun "fbsql_blob_new"       :pointer       (db :pointer) (tr :pointer))
(defcfun "fbsql_blob_create"    :void          (blob :pointer))
(defcfun "fbsql_blob_cancel"    :void          (blob :pointer))
(defcfun "fbsql_blob_open"      :void          (blob :pointer))
(defcfun "fbsql_blob_close"     :void          (blob :pointer))
(defcfun "fbsql_blob_read"      :uint32           (blob :pointer) (dest :pointer) (size :uint32))
(defcfun "fbsql_blob_write"     :void          (blob :pointer) (source :pointer) (size :uint32))
(defcfun "fbsql_blob_info"      :void          (blob :pointer) (source :pointer) (size :pointer) (largest :pointer) (segments :pointer))
(defcfun "fbsql_blob_save"      :void          (blob :pointer) (data :pointer) (size :uint32))
(defcfun "fbsql_blob_size"      :unsigned-int  (blob :pointer))
(defcfun "fbsql_blob_load"      :void          (blob :pointer) (data :pointer))
(defcfun "fbsql_blob_freemem"   :void          (blob :pointer) (data :pointer))
(defcfun "fbsql_blob_delete"    :void          (blob :pointer))

;;;; fbsql_error functions
(defcfun "fbsql_error_occured"  :uint32)
(defcfun "fbsql_error_msg_size" :unsigned-int)
(defcfun "fbsql_error_msg"      :void (buffer :pointer))
...
(defcfun "fbsql_service_new"                    :pointer (server :string) (user :string) (password :string))
(defcfun "fbsql_service_connect"                :void    (server :pointer))
(defcfun "fbsql_service_connected"              :int32   (server :pointer))
(defcfun "fbsql_service_disconnect"             :void    (server :pointer))
(defcfun "fbsql_service_get_version_size"       :int32   (server :pointer))
(defcfun "fbsql_service_get_version"            :void    (server :pointer) (buffer :pointer))
(defcfun "fbsql_service_add_user"               :void    (server :pointer) (user :pointer))
(defcfun "fbsql_service_get_user"               :void    (server :pointer) (user :pointer))
(defcfun "fbsql_service_modify_user"            :void    (server :pointer) (user :pointer))
(defcfun "fbsql_service_remove_user"            :void    (server :pointer) (user :pointer))
(defcfun "fbsql_service_set_page_buffers"       :void    (server :pointer) (db :string) (buffers :int32))
(defcfun "fbsql_service_set_sweep_interval"     :void    (server :pointer) (db :string) (sweep :int32))
(defcfun "fbsql_service_set_sync_write"         :void    (server :pointer) (db :string) (sync :int32))
(defcfun "fbsql_service_set_read_only"          :void    (server :pointer) (db :string) (read-only :int32))
(defcfun "fbsql_service_set_reserve_space"      :void    (server :pointer) (db :string) (read-only :int32))
(defcfun "fbsql_service_shutdown"               :void    (server :pointer) (db :string) (mode service-shutdown-modes) (timeout :int32))
(defcfun "fbsql_service_restart"                :void    (server :pointer) (db :string))
(defcfun "fbsql_service_sweep"                  :void    (server :pointer) (db :string))
(defcfun "fbsql_service_start_backup"           :void    (server :pointer) (db :string) (fbk :string) (flags service-backup-restore-flags))
(defcfun "fbsql_service_start_restore"          :void    (server :pointer) (fbk :string) (db :string) (pagesize :int) (flags service-backup-restore-flags))
(defcfun "fbsql_service_wait_msg"               :pointer (server :pointer))
(defcfun "fbsql_service_wait"                   :void    (server :pointer))
(defcfun "fbsql_service_get_user_list"          :pointer (server :pointer))
(defcfun "fbsql_service_delete"                 :void    (server :pointer))

(defcfun "fbsql_user_new"                    :pointer)
(defcfun "fbsql_user_get_name_size"          :int32   (user :pointer))
(defcfun "fbsql_user_get_name"               :int32   (user :pointer) (buf :string))
(defcfun "fbsql_user_get_password_size"      :int32   (user :pointer))
(defcfun "fbsql_user_get_password"           :int32   (user :pointer) (buf :string))
(defcfun "fbsql_user_get_firstname_size"     :int32   (user :pointer))
(defcfun "fbsql_user_get_firstname"          :int32   (user :pointer) (buf :string))
(defcfun "fbsql_user_get_lastname_size"      :int32   (user :pointer))
(defcfun "fbsql_user_get_lastname"           :int32   (user :pointer) (buf :string))
(defcfun "fbsql_user_get_middlename_size"    :int32   (user :pointer))
(defcfun "fbsql_user_get_middlename"         :int32   (user :pointer) (buf :string))
(defcfun "fbsql_user_get_userid"             :int32   (user :pointer))
(defcfun "fbsql_user_get_groupid"            :int32   (user :pointer))
(defcfun "fbsql_user_set_name"               :void    (user :pointer) (name :string))
(defcfun "fbsql_user_set_password"           :void    (user :pointer) (password :string))
(defcfun "fbsql_user_set_firstname"          :void    (user :pointer) (firstname :string))
(defcfun "fbsql_user_set_middlename"         :void    (user :pointer) (middlename :string))
(defcfun "fbsql_user_set_lastname"           :void    (user :pointer) (lastname :string))
(defcfun "fbsql_user_set_userid"             :void    (user :pointer) (userid :int32))
(defcfun "fbsql_user_set_groupid"            :void    (user :pointer) (groupid :int32))
(defcfun "fbsql_user_delete"                 :void    (user :pointer))

(defcfun "fbsql_user_list_count"             :uint32  (users :pointer))
(defcfun "fbsql_user_list_get"               :pointer (users :pointer) (index :uint32))
(defcfun "fbsql_user_list_delete"            :void    (users :pointer))
